...
import { Container, Card, Col, Pagination, Row } from 'react-bootstrap';
...
export default class Books extends Component {
  ...
  componentDidMount() {
    axios.post(`http://nyx.vima.ekt.gr:3000/api/books/?page=${this.state.currentPage}&itemsPerPage=${this.state.booksPerPage}`)
